...
$Projectname est un réseau de communication décentralisé, qui a pour but de proposer un moyen de communication  résistant à la censure, respecte la confidentialité et qui est indépendant des grandes entreprises mondiales. Ces companies géantes fonctionnent comme des espions. Ce sont des monopoles centralisés sur internet. A l'orignie internet ne fonctionnait pas ainsi, il était décentralisé.
